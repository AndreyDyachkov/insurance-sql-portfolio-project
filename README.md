...
- [`create_insurance_data_mart_2.sql`](https://github.com/AndreyDyachkov/insurance-sql-portfolio-project/blob/main/sql_queries/create_insurance_datamart_2.sql) 
